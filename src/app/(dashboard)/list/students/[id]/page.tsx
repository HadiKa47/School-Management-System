          ...
          <div className="bg-Sky py-6 px-4 rounded-md flex-1 flex gap-4">
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              ...
              <p className="text-sm text-gray-500">
                Lorem ipsum, dolor sit abet consectetur adipisicing edit. Lorem
                ipsum, dolor sit abet consectetur adipisicing edit. Lorem ipsum,
                dolor sit abet consectetur adipisicing edit. Lorem ipsum, dolor
                sit abet consectetur adipisicing edit.
              </p>
